...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 10, 2026 lúc 02:44 PM
...
('khong-bao-gio-chet-lai-lan-nua', 'Không Bao Giờ Chết Lại Lần Nữa', 'https://img.otruyenapi.com/uploads/comics/khong-bao-gio-chet-lai-lan-nua-thumb.jpg', 4839, '2026-01-02 14:54:22'),
...
('tu-than-phieu-nguyet', 'Tử Thần Phiêu Nguyệt', 'https://img.otruyenapi.com/uploads/comics/tu-than-phieu-nguyet-thumb.jpg', 4928, '2026-01-09 13:29:05'),
...
('world-embryo-remastered', 'World Embryo Remastered', 'https://img.otruyenapi.com/uploads/comics/world-embryo-remastered-thumb.jpg', 2538, '2026-01-09 13:16:51'),
...
INSERT INTO `notifications` (`id`, `sender_id`, `receiver_id`, `type`, `title`, `message`, `is_read`, `created_at`) VALUES
(2, NULL, 2, 'system', 'Chúc mừng', 'test', 1, '2026-01-08 00:16:13'),
(6, NULL, 2, 'system', 'test', '2', 1, '2026-01-08 00:19:12'),
(14, NULL, 2, 'system', 'chúc mừng năm mới', 'oke nhé e', 0, '2026-01-09 13:51:48'),
(15, NULL, 3, 'system', 'chúc mừng năm mới', 'oke nhé e', 1, '2026-01-09 13:51:48');
...
(51, 1, 'novel', '1', 'Đấu phá thương khung', 'https://nhanvat.wiki/wp-content/uploads/2023/01/dau-pha-thuong-khung.jpg', 'Chương 1: Thiên tài rơi rụng', '/WebDocTruyen/novel_read.php?id=1', '2026-01-10 13:16:20'),
...
--
-- Cấu trúc bảng cho diễn đàn và chat
--
...
INSERT IGNORE INTO `forum_categories` (`id`, `name`, `slug`) VALUES
