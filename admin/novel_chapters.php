...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="chapter_add.php?novel_id=<?= $novel_id ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Thêm Chương Mới</a>
</div>
            ...
            res.data.forEach((c, index) => {
                ...
                <tr id="chap-row-${c.id}">
                    ...
                    <td class="text-center">
                        <a href="chapter_edit.php?id=${c.id}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
