...
// Đảm bảo chỉ được include, không được lọt trực tiếp
if (!defined('ADMIN_VIEW')) exit('Direct access not permitted');
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <script src="../js/api.js"></script> <!-- Chèn bộ API xịn xò -->
...
<div class="d-flex">
    ...
    <div class="sidebar d-flex flex-column flex-shrink-0 p-3" style="width: 250px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto mt-3" id="admin-menu">
            <li><a href="index.php" class="nav-link mb-2 <?php if($active_menu=='dashboard') echo 'active'; ?>"><i class="fas fa-tachometer-alt me-2"></i> Dashboard</a></li>
            <li><a href="novels.php" class="nav-link mb-2 <?php if($active_menu=='novels') echo 'active'; ?>"><i class="fas fa-book me-2"></i> Quản lý Truyện</a></li>
            <li><a href="categories.php" class="nav-link mb-2 <?php if($active_menu=='categories') echo 'active'; ?>"><i class="fas fa-folder me-2"></i> Quản lý Thể loại</a></li>
            
            <?php if (($_SESSION['role'] ?? '') === 'admin'): ?>
                <li><a href="manage_users.php" class="nav-link mb-2 <?php if($active_menu=='users') echo 'active'; ?>"><i class="fas fa-users me-2"></i> Quản lý Thành viên</a></li>
                <li><a href="manage_comments.php" class="nav-link mb-2 <?php if($active_menu=='comments') echo 'active'; ?>"><i class="fas fa-comments me-2"></i> Quản lý Bình luận</a></li>
                <li><a href="notifications.php" class="nav-link mb-2 <?php if($active_menu=='notifications') echo 'active'; ?>"><i class="fas fa-bullhorn me-2"></i> Gửi Thông Báo</a></li>
            <?php endif; ?>
