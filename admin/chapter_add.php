<?php
// File: admin/chapter_add.php
session_start();
if (!isset($_SESSION['user_id'])) { header("Location: ../login.php"); exit; }
define('ADMIN_VIEW', true);
$page_title = 'Thêm Chương Mới';
$active_menu = 'novels';
ob_start();
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="novel_chapters.php?novel_id=<?= $novel_id ?>" class="btn btn-outline-secondary"><i class="fas fa-arrow-left"></i> Quay lại Danh sách</a>
</div>
...
document.getElementById('add-chapter-form').addEventListener('submit', async function(e) {
    ...
    if (res && res.status === 'success') {
        window.location.href = 'novel_chapters.php?novel_id=' + novelId;
    } else {
