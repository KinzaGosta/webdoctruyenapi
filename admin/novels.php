            ...
            res.data.forEach(n => {
                ...
                <tr id="novel-row-${n.id}">
                    ...
                    <td class="text-center">
                        <a href="novel_chapters.php?novel_id=${n.id}" class="btn btn-sm btn-info text-white" title="Quản lý chương"><i class="fas fa-list"></i></a>
                        <a href="novel_edit.php?id=${n.id}" class="btn btn-sm btn-warning" title="Chỉnh sửa"><i class="fas fa-edit"></i></a>
