...
require_once 'includes/functions.php'; // Nếu có hàm createSlug hoặc helper
                        ...
                        <div class="book-card">
                            ...
                            <div class="book-body">
                                <div class="book-title">
                                    <a href="novel_detail.php?id=<?= $novel['id'] ?>" title="<?= htmlspecialchars($novel['title']) ?>">
                ...
                ?>
                    <div class="col">
                        <div class="book-card">
                            ...
                            <div class="book-body">
                                <div class="book-title">
                                    <a href="comic_detail.php?slug=<?= $comic['slug'] ?>" title="<?= htmlspecialchars($comic['name']) ?>">
