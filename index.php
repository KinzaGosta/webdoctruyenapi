    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                ...
                <a href="list_comics.php" class="btn btn-sm btn-outline-primary">Xem thêm <i class="fas fa-arrow-right"></i></a>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                ...
                <a href="list_novels.php" class="btn btn-sm btn-outline-success">Xem thêm <i class="fas fa-arrow-right"></i></a>
            </div>
        ...
        <div class="col-lg-4">
            ...
            <?php 
                if (file_exists('includes/top_view.php')) {
                    // Tạm thời include top view, tí nữa chuyển sang JS luôn cho đồng nhất
                    include 'includes/top_view.php';
                }
            ?>
    ...
    if (res && res.status === 'success' && res.data && res.data.data.items) {
        ...
        let html = comics.map(comic => {
            ...
            <div class="col-4 col-md-3"> 
                <div class="book-card">
                    <a href="comic_detail.php?slug=${comic.slug}" class="book-thumb">
                    ...
                    <div class="book-body">
                        <h3 class="book-title">
                            <a href="comic_detail.php?slug=${comic.slug}" title="${comic.name}">${comic.name}</a>
                        </h3>
...
async function loadHomeNovels() {
    ...
    if (res && res.status === 'success' && res.data.length > 0) {
        let html = res.data.map(novel => {
            ...
            <div class="col-4 col-md-3">
                <div class="book-card">
                    <a href="novel_detail.php?id=${novel.id}" class="book-thumb">
                        <img src="${cover}" alt="${novel.title}" loading="lazy">
                        <span class="badge ${color} badge-overlay">${label}</span>
                    </a>
                    <div class="book-body">
                        <h3 class="book-title">
                            <a href="novel_detail.php?id=${novel.id}" title="${novel.title}">${novel.title}</a>
                        </h3>
                        <div class="book-info d-flex justify-content-between align-items-center">
